...
//    [CombancHUD showProgress:0 WithMaskType:SVProgressHUDMaskTypeNone hudStyle:SVProgressHUDStyleCustom backgroundColor:[UIColor clearColor] backgroundLayerColor:[UIColor clearColor]];
...
//            [CombancHUD showProgress:MAX(MIN(1, progress), 0) WithMaskType:SVProgressHUDMaskTypeNone hudStyle:SVProgressHUDStyleCustom backgroundColor:[UIColor clearColor] backgroundLayerColor:[UIColor clearColor]];
            [SVProgressHUD showProgress:MAX(MIN(1, progress), 0)];
        }
    });
}
