...
static CGFloat const PKRecordButtonWidth = 150;
...
- (void)viewDidLoad {
    ...
    CGFloat spaceHeight = ceilf( (kScreenHeight - kTabHeight - PKPreviewLayerHeight)/3 );
    ...
    UIToolbar *toolbar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kTabHeight)];
    ...
    previewLayer.frame = CGRectMake(0, kTabHeight, kScreenWidth, PKPreviewLayerHeight);
    [self.view.layer insertSublayer:previewLayer atIndex:0];
    
    self.progressBar = [[PKShortVideoProgressBar alloc] initWithFrame:CGRectMake(0, kTabHeight + PKPreviewLayerHeight - 5, kScreenWidth, 5) themeColor:self.themeColor duration:self.videoMaximumDuration];
