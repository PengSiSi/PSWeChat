...
- (void)viewDidLoad {
    ...
    [table registerClass:[AddressBookCell class] forCellReuseIdentifier:NSStringFromClass([AddressBookCell class])];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(dataSource.count > 0)
    {
        ...
        [cell.iconImgView sd_setImageWithURL:[NSURL URLWithString:friends.photo] placeholderImage:[UIImage imageNamed:@"default_portrait"] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
        }];
        cell.iconImgView.backgroundColor = [UIColor lightGrayColor];
